...
beforeEach(() => {
  jest.clearAllMocks();
  // mockReset() clears any queued .mockResolvedValueOnce() returns from prior
  // tests so each test starts with a clean queue.
...
describe('Chat stream events still work after multi-source routing is added', () => {
  ...
  test('Chat stream INSERT triggers ConverseCommand, not InvokeModelCommand', async () => {
